...
def get_info(path:str,attr:str=None):
    return wrap_error(_get_info,path)
...
def download_path(path:str,dest=None,file_name = None):
    return wrap_error(_download_path,path,dest,file_name)

def upload_path(path:str,dest:str):
    return wrap_error(_upload_path,path,dest)

def create_folder(path:str,folder:str):
    return wrap_error(_create_folder,path,dest)
...
def _upload_path(synd,path,dest):
    return synd.upload_file(path, dest_folder_path=dest)
